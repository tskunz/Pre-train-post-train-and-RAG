...
Students will pre-train **TWO embedding models from scratch** (20m-200m parameters each):
...
- **Model Size**: 20m-200m parameters for each model
...
- **Dataset**: Generate synthetic data using the Paul Graham corpus 
...
- **Training Comparison**: Compare three training approaches:
  1. **Synthetic data only**: Generated by LLMs
  2. **Base only**: Manually created or extracted
  3. **Both**: Combined synthetic + base data
...
**Datasets and Codes:**
- Pre-processed collection of essays
  - https://github.com/TonicAI/tonic_validate/tree/main/examples/paul_graham_essays 
- GitHub repository
  - https://github.com/TonicAI/tonic_validate/tree/main
